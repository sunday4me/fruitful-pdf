...
func main() {
	...
	err := m.OutputFileAndClose("pdfs/sunday.pdf")
	if err != nil {
...
func buildHeading(m pdf.Maroto) {
	m.RegisterHeader(func() {
		m.Row(50, func() {
			m.Col(12, func() {
				err := m.FileImage("images/sunday.jpg", props.Rect{
					Center:  true,
					Percent: 75,
				})
	...
	m.Row(10, func() {
		m.Col(12, func() {
			_ = m.Barcode("https://github.com/sunday4me", props.Barcode{
				Percent:    75,
...
func buildSignature(m pdf.Maroto) {
	m.Row(15, func() {
		m.Col(5, func() {
			m.QrCode("https://github.com/sunday4me", props.Rect{
				Left:    0,
				Top:     5,
				Center:  false,
				Percent: 100,
